...
public class BeerDTOPageImpl<BeerDTO> extends PageImpl<guru.springframework.spring6resttemplate.model.BeerDTO> {
    ...
    // alt enter and create constructor matching super then u get constructor
    // no Creators, like default constructor, exist)
    // org.springframework.data.domain.PageImpl["pageable"])
    // to avoid this error ignore




    // mentioning T above means generics
}
